...
type SendEmail struct {
	...
	EmailSubject string `protobuf:"bytes,1,opt,name=email_subject,json=emailSubject,proto3" json:"email_subject,omitempty" dynamodbav:"email_subject,omitempty"`
	// @gotags: dynamodbav:"receiver_email,omitempty"
	ReceiverEmailAddress string `protobuf:"bytes,2,opt,name=receiver_email_address,json=receiverEmailAddress,proto3" json:"receiver_email_address,omitempty" dynamodbav:"receiver_email,omitempty"`
	// @gotags: dynamodbav:"receiver_name,omitempty"
	ReceiverName string `protobuf:"bytes,3,opt,name=receiver_name,json=receiverName,proto3" json:"receiver_name,omitempty" dynamodbav:"receiver_name,omitempty"`
	// @gotags: dynamodbav:"email_template,omitempty"
	EmailPurpose EmailTemplate `protobuf:"varint,4,opt,name=email_purpose,json=emailPurpose,proto3,enum=v1.EmailTemplate" json:"email_purpose,omitempty" dynamodbav:"email_template,omitempty"`
...
func (x *SendEmail) GetEmailSubject() string {
	if x != nil {
...
func (x *SendEmail) GetReceiverEmailAddress() string {
	if x != nil {
...
func (x *SendEmail) GetReceiverName() string {
	if x != nil {
...
func (x *SendEmail) GetEmailPurpose() EmailTemplate {
	if x != nil {
		return x.EmailPurpose
	}
	return EmailTemplate_INVITATION
}

func (x *SendEmail) GetToken() string {
	if x != nil {
		return x.Token
	}
	return ""
...
func (x *SendEmail) GetSuccess() bool {
	if x != nil {
		return x.Success
	}
	return false
...
var file_send_email_proto_rawDesc = []byte{
	...
	,
	...
	0x65, 0x63, 0x65, 0x69, 0x76, 0x65, 0x72, 0x4e, 0x61, 0x6d, 0x65, 0x12, 0x37, 0x0a, 0x0d, 0x65,
	0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x70, 0x75, 0x72, 0x70, 0x6f, 0x73, 0x65, 0x18, 0x04, 0x20, 0x01,
	0x28, 0x0e, 0x32, 0x12, 0x2e, 0x76, 0x31, 0x2e, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x5f, 0x74, 0x65,
	0x6d, 0x70, 0x6c, 0x61, 0x74, 0x65, 0x52, 0x0c, 0x65, 0x6d, 0x61, 0x69, 0x6c, 0x50, 0x75, 0x72,
	0x70, 0x6f, 0x73, 0x65, 0x12, 0x14, 0x0a, 0x05, 0x74, 0x6f, 0x6b, 0x65, 0x6e, 0x18, 0x05, 0x20,
	...
	0x63, 0x65, 0x73, 0x73, 0x42, 0x6d, 0x0a, 0x06, 0x63, 0x6f, 0x6d, 0x2e, 0x76, 0x31, 0x42, 0x0e,
	0x53, 0x65, 0x6e, 0x64, 0x45, 0x6d, 0x61, 0x69, 0x6c, 0x50, 0x72, 0x6f, 0x74, 0x6f, 0x50, 0x01,
...
var file_send_email_proto_goTypes = []interface{}{
	(*SendEmail)(nil),  // 0: v1.send_email
	(EmailTemplate)(0), // 1: v1.email_template
}
var file_send_email_proto_depIdxs = []int32{
	1, // 0: v1.send_email.email_purpose:type_name -> v1.email_template
