...
func (api menuApi) createCategories(ctx echo.Context) error {
	data := &v1.Categories{}
	err := ctx.Bind(data)
	if err != nil {
...
func (api menuApi) CreateCategories(ctx context.Context, data *v1.Categories) (*v1.ItemResponse, error) {
	valid := data.Validate()
	if valid != nil {
