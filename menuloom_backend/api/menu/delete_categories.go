...
func (api menuApi) deleteCategories(ctx echo.Context) error {
	data := &v1.Categories{}
	err := ctx.Bind(data)
	if err != nil {
...
func (api menuApi) DeleteCategories(ctx context.Context, data *v1.Categories) (*v1.ItemResponse, error) {
	valid := data.Validate()
	if valid != nil {
